...
exports.checkEventNameMiddleware = void 0;
const core_1 = require("../../../../core");
const express_validator_1 = require("express-validator");
const config_1 = require("../../../../config");
const bad_request_error_1 = require("../../../../core/domain/errors/bad-request-error");
const { eventsUseCase } = (0, config_1.configureDependencies)();
const checkEventNameMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (errors.isEmpty()) {
        try {
            ...
            const nameExist = yield eventsUseCase.validateDuplicatedData((_a = commerceId === null || commerceId === void 0 ? void 0 : commerceId.toString()) !== null && _a !== void 0 ? _a : '', name);
            if (nameExist)
...
exports.checkEventNameMiddleware = checkEventNameMiddleware;
